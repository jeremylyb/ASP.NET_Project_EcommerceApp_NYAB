...
Customer_CreditCardNumber NVARCHAR(max) NOT NULL,
...
CREATE DATABASE NotYourAverageBicep
GO

USE NotYourAverageBicep
GO


CREATE TABLE [NotYourAverageBicep].[dbo].Products (
    Product_Id int NOT NULL PRIMARY KEY IDENTITY(50001, 1),
    Product_Name nvarchar(300) NOT NULL,
    Product_Price decimal(10,2) NOT NULL,
    Product_Image nvarchar(max) NOT NULL,
...
GO
--Example Data...
INSERT INTO [NotYourAverageBicep].[dbo].Products (Product_Name, Product_Price, Product_Image, Product_Overview, Product_Benefits) 
	VALUES ( 
		'Impact Whey Protein', 
		45.99, 
		'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/alpinejs/alpinejs-original.svg', 
...
CREATE TABLE [NotYourAverageBicep].[dbo].Carts (
Cart_Id int NOT NULL PRIMARY KEY IDENTITY (101, 1),
Cart_Price decimal(10, 2) NULL)
GO
CREATE TABLE [NotYourAverageBicep].[dbo].Cart_Items (
Cart_Item_Id int NOT NULL PRIMARY KEY IDENTITY(2000001, 1),
Product_Id int NOT NULL,
Quantity int NOT NULL,
Fk_Cart_Id int NOT NULL FOREIGN KEY (Fk_Cart_Id) REFERENCES
[NotYourAverageBicep].[dbo].Carts(Cart_Id))
GO

CREATE TABLE [NotYourAverageBicep].[dbo].Orders (
Order_Id int NOT NULL PRIMARY KEY IDENTITY (7001, 1),
Customer_Name NVARCHAR(50) NOT NULL ,
Customer_Address NVARCHAR(max) NOT NULL,
Customer_CreditCardNumber NVARCHAR(max) NOT NULL,
